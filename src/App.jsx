...
const SecNumAcademy = () => {
  ...
  const handleRegister = (e) => {
    ...
    const newUser = {
      ...
      modules: {
        1: { timeSpent: 12, score: 75 },
        2: { timeSpent: 8, score: 75 },
        3: { timeSpent: 0, score: 75 },
        4: { timeSpent: 5, score: 75 }
      }
    };
  ...
  const modules = [
    {
      ...
      timeSpent: currentUser?.modules?.[1]?.timeSpent || 12,
      score: currentUser?.modules?.[1]?.score || 75
    },
    {
      id: 2,
      title: "Sécurité de l'authentification",
      timeSpent: currentUser?.modules?.[2]?.timeSpent || 8,
    ...
    },
    {
      ...
      timeSpent: currentUser?.modules?.[4]?.timeSpent || 5,
